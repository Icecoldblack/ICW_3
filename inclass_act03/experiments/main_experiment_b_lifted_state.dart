...
class _ControlDeckScreenState extends State<ControlDeckScreen> {
  ...
  // EXPERIMENT B: isPressed lifted OUT of _TactileButtonState and into the
  // parent. One shared boolean now backs all five buttons.
  bool isPressed = false;
  void _setPressed(bool v) => setState(() => isPressed = v);
...
class TactileButton extends StatefulWidget {
  ...
  final bool isPressed; // EXPERIMENT B: now owned by the parent.
  final ValueChanged<bool> onPressedChanged; // EXPERIMENT B: pushes state up.
...
class _TactileButtonState extends State<TactileButton> {
  // EXPERIMENT B: the local flag is gone. This now reads the parent's single
  // shared boolean, which is exactly the bug Question 1 describes.
  bool get isPressed => widget.isPressed;
